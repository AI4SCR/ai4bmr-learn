...
class PCa2025(L.LightningDataModule):
    ...
    def __init__(
        ...
        self.dataset_dir = base_dir / "PCa2025"
    ...
    def prepare_data(self) -> None:
        ...
        dm = PCa(base_dir=base_dir)
        dm.setup(image_version='filtered', mask_version='annotated')

        # preprocessing
        if not self.images_dir.exists():
            include_channels = ['smooth_muscle_actin',
            ...
            preprocess_images(images=dm.images, panel=dm.panel, save_dir=self.images_dir, include_channels=include_channels)
    ...
    def prepare_coords(self):
        ...
        counter = Counter(rng.choice(list(ids), size=50_000, replace=True))
