...
class Parameters:
    ...
    head_dim: list[int] = field(default_factory=lambda: [8, 16, 32])
    n_heads: list[int] = field(default_factory=lambda: [1, 2, 4])
...
def get_best_param_index(scores: pd.DataFrame, scoring="abmil:test/accuracy-macro", maximize=True):
